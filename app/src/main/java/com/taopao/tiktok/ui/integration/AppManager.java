...
import static com.taopao.tiktok.ui.base.Platform.DEPENDENCY_SUPPORT_DESIGN;
...
public final class AppManager {
    ...
    public void startActivity(Intent intent) {
        if (getTopActivity() == null) {
            Log.d(TAG, "mCurrentActivity == null when startActivity(Intent)");
    ...
    public Activity getTopActivity() {
        if (mActivityList == null) {
            Log.d(TAG, "mActivityList == null when getTopActivity()");
            return null;
        }
    ...
    public void killActivity(Class<?> activityClass) {
        if (mActivityList == null) {
            Log.d(TAG, "mActivityList == null when killActivity(Class)");
            return;
        }
        synchronized (AppManager.class) {
    ...
    public boolean activityInstanceIsLive(Activity activity) {
        if (mActivityList == null) {
            Log.d(TAG, "mActivityList == null when activityInstanceIsLive(Activity)");
            return false;
        }
    ...
    public boolean activityClassIsLive(Class<?> activityClass) {
        if (mActivityList == null) {
            Log.d(TAG, "mActivityList == null when activityClassIsLive(Class)");
            return false;
        }
    ...
    public Activity findActivity(Class<?> activityClass) {
        if (mActivityList == null) {
            Log.d(TAG, "mActivityList == null when findActivity(Class)");
            return null;
        }
        for (Activity activity : mActivityList) {
            if (activity.getClass().equals(activityClass)) {
