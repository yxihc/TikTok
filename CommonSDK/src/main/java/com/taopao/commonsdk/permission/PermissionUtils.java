...
public class PermissionUtils {
    ...
    static ArrayList<String> getFailPermissions(Context context, List<String> permissions) {
        ...
        for (String permission : permissions) {
            ...
            //检测安装权限
            if (permission.equals(RequestPermissions.REQUEST_INSTALL_PACKAGES)) {
            ...
            //检测悬浮窗权限
            if (permission.equals(RequestPermissions.SYSTEM_ALERT_WINDOW)) {
    ...
    static void checkTargetSdkVersion(Context context, List<String> requestPermissions) {
        //检查是否包含了8.0的权限
        if (requestPermissions.contains(RequestPermissions.REQUEST_INSTALL_PACKAGES)
                || requestPermissions.contains(RequestPermissions.ANSWER_PHONE_CALLS)
                || requestPermissions.contains(RequestPermissions.READ_PHONE_NUMBERS)) {
